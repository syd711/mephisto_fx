...
public class Footer {
  ...
  private static final String STYLE_INACTIVE = "-fx-border-color: " + Colors.HEX_COLOR_SEPARATOR + " transparent transparent "
      + Colors.HEX_COLOR_SEPARATOR + ";-fx-background-color: " + Colors.HEX_COLOR_INACTIVE + ";";
  private static final String STYLE_ACTIVE = "-fx-background-color: " + Colors.HEX_COLOR_BACKGROUND + ";-fx-border-color: transparent transparent transparent " + Colors.HEX_COLOR_SEPARATOR + ";";
  private static final String STYLE_ACTIVE_1 = "-fx-background-color: " + Colors.HEX_COLOR_BACKGROUND + ";-fx-border-color: transparent transparent transparent transparent;";
  ...
  public Footer(BorderPane root) {
    ...
    //radio tab
    tab1 = new HBox(0);
    tab1.setMinWidth(TransitionUtil.WIDTH/3);
    ...
    //weather tab
    tab2 = new HBox(0);
    tab2.setMinWidth(TransitionUtil.WIDTH / 3);
    ...
    //google tab
    tab3 = new HBox(0);
    tab3.setMinWidth(TransitionUtil.WIDTH / 3);
